(function() {
    ...
    angular.module('starter').factory('challengeApi', ['$http', '$q', '$ionicLoading', 'DSCacheFactory', challengeApi]);

    function challengeApi($http, $q, $ionicLoading, DSCacheFactory) {
        ...
        function getLeagues() {
            ...
            if (leaguesData) {
                ...
                $http.get("http://challenge.eu-central-1.elasticbeanstalk.com/v1/leagues")
        ...
        function getLeagueData(forceRefresh) {
            ...
            if (leagueData) {
                ...
                $http.get("http://challenge.eu-central-1.elasticbeanstalk.com/v1/leagues/" + getLeagueId())

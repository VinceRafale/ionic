(function() {
	...
	MyCartController.$inject = ['$ionicListDelegate', 'shoppingCartService', 'orderProcessor'];

	/* @ngInject */
	function MyCartController($ionicListDelegate, shoppingCartService, orderProcessor) {
		...
		function flushCart() {
			shoppingCartService.addBoughtItems();

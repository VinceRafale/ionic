(function() {
	...
	orderProcessor.$inject = ['$filter', '$cordovaEmailComposer', 'externalAppsService','$state'];

	/* @ngInject */
	function orderProcessor($filter, $cordovaEmailComposer, externalAppsService,$state) {
		...
		function generateSubject() {
			return 'challenge Store - Order No ' + Math.floor((Math.random() * 9000) + 1000);
		}
	}
})();

(function() {
	...
	LoStorageController.$inject = ['loStorageService', '$ionicListDelegate', 'editLoStorageItemService'];

	/* @ngInject */
	function LoStorageController(loStorageService, $ionicListDelegate, editLoStorageItemService) {
